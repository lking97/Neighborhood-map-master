...
function initMap(){ 'use strict';
map = new google.maps.Map(document.getElementById('map'), {
    zoom: 14,
    center: {lat: 38.245012, lng: -122.039797}
});
}

//Get the valid Phone number, referenced from snipplr
function formatPhone(phonenum) { 'use strict';
...
var Location = function(data){ 'use strict';
    var self = this;
    this.name = data.name;
    this.lat = data.lat;
    this.lng = data.lng;
...
function AppViewModel(){ 'use strict';
    var self = this;
...
function startApp() { 'use strict';
    ko.applyBindings(new AppViewModel());
}

function errorHandling() { 'use strict';
